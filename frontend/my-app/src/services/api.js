...
export const cartAPI = {
  ...
  addToCart: (productId, quantity, options = {}) => api.post('/cart/items', { productId, quantity, ...options }),
...
export const accountAPI = {
  ...
  createAddress: (address) => api.post('/account/addresses', address),
  updateAddress: (id, address) => api.patch(`/account/addresses/${id}`, address),
...
export const paymentAPI = {
  getPaymentStatus: (orderId) => api.get(`/payments/orders/${orderId}/status`),
  createPaymentIntent: (orderId) => api.post(`/payments/orders/${orderId}/intent`, {}),
};
...
export const reviewAPI = {
  ...
  createReview: (productId, payload) => api.post(`/reviews/product/${productId}`, payload),
  updateReview: (reviewId, payload) => api.patch(`/reviews/${reviewId}`, payload),
...
export const adminAPI = {
  ...
  toggleProductVisibility: (id, isActive) => api.patch(`/admin/products/${id}/visibility`, { isActive }),
